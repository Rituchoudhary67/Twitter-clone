    ...
    document.getElementById('tweet-body').insertAdjacentHTML('beforeend', tweets.data.map((tweet) => {
        ...
        return `<div id=${tweet._id} class="tweets">
            ...
            <div class="tweet-header">
                ...
                <p><strong>Ritu Choudhary</strong></p>
                <p>@Rituchow</p>
...
document.addEventListener('click', async (event) => {
    if(event.target.classList.contains('front-tweet-post-btn')) {
        const tweetText = document.querySelector('.front-tweet-post-text').value;
